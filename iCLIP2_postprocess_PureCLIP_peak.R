...
sampleX <- argv[1]
#sampleX <- 'WT'
plus_bw.file <- paste0('peak/', sampleX, '_merged.shifted.plus.bw')
minus_bw.file <- paste0('peak/', sampleX, '_merged.shifted.minus.bw')
peak.file <- paste0('peak/', sampleX, '_PureCLIP.crosslink_sites_short.bed')
...
export(peaks_sc_m,  paste0('results/', sampleX, "_sign_sites_max_gap_width_7.bed"))
...
### Cleanup
rm(list = setdiff(ls(), c("sampleX", "peaks_sc_m_pw", "peaks_sc_m_pw_sc", "plus_cov", "minus_cov")))
...
### Cleanup
rm(list = setdiff(ls(), c("sampleX", "peaks_sc_m_pw", "peaks_sc_m_pw_sc", "peaks_sc_m_pw_long_plus_curated", "plus_cov", "minus_cov")))
...
### Cleanup
rm(list = setdiff(ls(), c("sampleX", "peaks_sc_m_pw", "peaks_sc_m_pw_sc", "peaks_sc_m_pw_long_plus_curated", "peaks_sc_m_pw_long_minus_curated", "plus_cov", "minus_cov")))
...
### Cleanup
rm(list = setdiff(ls(), c("sampleX", "peaks_sl_curated", "plus_cov", "minus_cov")))
...
export(peaks_curated, paste0('results/', sampleX, "_peaks_curated.bed"))
